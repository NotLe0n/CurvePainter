...
namespace CurvePainter
{
    public class Line
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            // draw control points
            spriteBatch.Draw(CurvePainter.solid, new Rectangle((int)startPoint.X - 5, (int)startPoint.Y - 5, 10, 10), Color.Red);
            spriteBatch.Draw(CurvePainter.solid, new Rectangle((int)endPoint.X - 5, (int)endPoint.Y - 5, 10, 10), Color.Red);
        }
    }
}
