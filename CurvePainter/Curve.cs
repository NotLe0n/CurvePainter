    ...
    public abstract class Curve
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            for (int i = 0; i < points.Length; i++)
            {
                ...
                currentDistance = Vector2.DistanceSquared(points[i], Input.MousePosition);
        ...
        public virtual void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (IsHovering || Selected)
            {
                ...
                {
                    spriteBatch.Draw(CurvePainter.solid, new Rectangle((int)control.X - 5, (int)control.Y - 5, 10, 10), Color.Red);
                }
            }
